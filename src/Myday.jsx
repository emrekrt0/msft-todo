        ...
        <div className="mainBackground">
            ...
            <div className="addTaskParent">
                ...
                <div className="baseAdd addTask">
                    ...
                    <svg fill="currentColor" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 3a7 7 0 100 14 7 7 0 000-14zm-8 7a8 8 0 1116 0 8 8 0 01-16 0z" ></path></svg>
                    </button>
                ...
                <div key={task.id} className="baseAdd addTask box-shadow mb-20 ts">
                    ...
                    <ul>
                        <li className={`baseAddInput-important ${task.id === editingTaskId ? 'editMode' : ''}`}>
                            <div className="whatTodo">{task.id !== editingTaskId ? task.todo : 
